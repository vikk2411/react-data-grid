...
const KeyboardHandler = Component => {
  return class extends React.Component {
    ...
    onKeyDown(e) {
      ...
      if (
        this.props.onGridKeyDown &&
        typeof this.props.onGridKeyDown === 'function'
      ) {
    ...
    onKeyUp(e) {
      ...
      if (
        this.props.onGridKeyUp &&
        typeof this.props.onGridKeyUp === 'function'
      ) {
    ...
    render() {
      return <Component {...this.props} isKeyDown={this.isKeyDown}/>;
    }
  };
};
